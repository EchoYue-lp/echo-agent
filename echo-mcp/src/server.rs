...
//! #         Box::pin(async { Ok(ToolResult::success("ok".into())) })
//! #     }
//! # }
//!
//! # #[tokio::main]
...
use crate::types::{
    ...
    JsonRpcResponse, MCP_PROTOCOL_VERSION, McpContent, McpTool, McpToolCallParams,
    McpToolCallResult, McpToolsListResult, SUPPORTED_PROTOCOL_VERSIONS, ServerCapabilities,
...
mod tests {
    ...
    #[test]
    fn test_version_negotiation_unsupported_returns_latest() {
        let server = McpServer::builder().build();

        // 客户端请求不支持的版本 → 服务端回复最新版本
