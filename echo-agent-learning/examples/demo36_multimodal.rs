...
//! cargo run -p echo-agent-learning --example demo36_multimodal
//!
//! # 或者显式指定配置文件路径
//! ECHO_AGENT_CONFIG=/path/to/application configuration cargo run -p echo-agent-learning --example demo36_multimodal
//! ```
