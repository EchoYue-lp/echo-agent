...
evidence_refs: [evidence.effects-extensions, evidence.persistence-observation, evidence.trace-effect-producers-current-repair, evidence.trace-effect-producers-current-verification]
...
verification_evidence_refs: [evidence.trace-effect-producers-current-verification]
rereview_audit_refs: [audit.trace-effect-event-producers-rereview]
...
17 个 RunEvent 变体的真实 producer matrix、effect ordering 和“不从 generic shell 推断副作用”合同已固化；background abort 后恢复责任仍由 #38/#61 embedding owner 承担。
