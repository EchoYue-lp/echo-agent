...
//!
//! Implements [`LlmClient`] for Ollama's `/api/chat` endpoint.
//! Streaming uses NDJSON (one JSON object per line, `done: true` terminates).

use crate::error::{LlmError, Result};
use crate::llm::types::{DeltaMessage, FunctionCall, Message, ToolCall};
use crate::llm::{BoxStream, ChatChunk, ChatRequest, ChatResponse, LlmClient};
