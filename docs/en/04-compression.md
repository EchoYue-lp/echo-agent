...
See [demo53_adaptive_compression.rs](../../echo-agent-learning/tests/example_contracts/demo53_adaptive_compression.rs).
...
See: `echo-agent-learning/examples/demo05_compressor.rs`, `echo-agent-learning/tests/example_contracts/demo53_adaptive_compression.rs`
