...
教学 crate 的 [`Cargo.toml`](../../../echo-rust-learning/Cargo.toml) 包含三类关键信息：
...
[`echo-rust-learning/src/lib.rs`](../../../echo-rust-learning/src/lib.rs) 声明顶层模块：
...
- [`echo-rust-learning/src/lib.rs`](../../../echo-rust-learning/src/lib.rs)：教学代码入口。
