...
[`chapter_01_basics.rs`](../../../echo-rust-learning/examples/chapter_01_basics.rs)，并能解释每个值的
类型、作用域和控制流。
...
完整实现见 [`fundamentals.rs`](../../../echo-rust-learning/src/fundamentals.rs)。
...
- [`fundamentals.rs`](../../../echo-rust-learning/src/fundamentals.rs)：本章完整可运行实现。
