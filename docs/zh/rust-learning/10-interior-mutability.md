...
教学代码的 [`SharedProgress`](../../../echo-rust-learning/src/smart_pointers/synchronization.rs) 使用
...
[`AtomicProgress`](../../../echo-rust-learning/src/smart_pointers/synchronization.rs) 展示了相同模式。
...
- [`synchronization.rs`](../../../echo-rust-learning/src/smart_pointers/synchronization.rs)：锁和原子教学实现。
