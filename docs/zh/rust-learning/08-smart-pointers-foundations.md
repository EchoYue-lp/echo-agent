...
完整代码见
[`box_pointer.rs`](../../../echo-rust-learning/src/smart_pointers/box_pointer.rs)。运行：
...
教学 [`PromptBox`](../../../echo-rust-learning/src/smart_pointers/box_pointer.rs) 包装 `Box<str>`：
...
教学 [`DropCounter`](../../../echo-rust-learning/src/smart_pointers/box_pointer.rs) 用 AtomicUsize 让
