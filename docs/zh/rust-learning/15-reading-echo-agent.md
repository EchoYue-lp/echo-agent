...
教学 crate 的 [`chapter_15_echo_agent_tool.rs`](../../../echo-rust-learning/examples/chapter_15_echo_agent_tool.rs)
离线执行真实 `#[tool]`。先运行：
...
完成后继续阅读项目的[快速上手](../getting-started.md)和[工具系统](../02-tools.md)，将这套阅读方法
用于真实 Agent 功能。
