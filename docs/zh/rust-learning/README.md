...
[`echo-rust-learning`](../../../echo-rust-learning/README.md)，只依赖框架公开 API，不参与任何生产
...
| 模块 | 主要知识 |
|------|----------|
| [`fundamentals.rs`](../../../echo-rust-learning/src/fundamentals.rs) | 基础类型、切片、控制流、模式匹配 |
| [`basics.rs`](../../../echo-rust-learning/src/basics.rs) | 领域结构、方法、UTF-8 安全处理 |
| [`ownership.rs`](../../../echo-rust-learning/src/ownership.rs) | move、borrow、生命周期与 newtype |
| [`collections.rs`](../../../echo-rust-learning/src/collections.rs) | Vec、HashMap、HashSet、闭包、迭代器 |
| [`errors.rs`](../../../echo-rust-learning/src/errors.rs) | Option、Result、thiserror 与上下文 |
| [`traits.rs`](../../../echo-rust-learning/src/traits.rs) | trait、泛型、动态分发与 Builder |
| [`smart_pointers`](../../../echo-rust-learning/src/smart_pointers/mod.rs) | Box、Rc、Arc、Weak、RefCell、锁、Cow、Pin |
| [`async_concurrency.rs`](../../../echo-rust-learning/src/async_concurrency.rs) | Tokio 任务、channel、超时与取消 |
| [`serialization.rs`](../../../echo-rust-learning/src/serialization.rs) | Serde 与验证边界 |
| [`project_patterns.rs`](../../../echo-rust-learning/src/project_patterns.rs) | 真实 echo-agent `#[tool]` API |
