...
///
/// # Safety
/// This function modifies the process environment. It is safe to call
/// from the main thread during plugin initialization, but not from
/// multiple threads simultaneously.
pub fn export_to_env(vars: &PluginVariables) {
    // SAFETY: Called during single-threaded plugin initialization.
    unsafe {
